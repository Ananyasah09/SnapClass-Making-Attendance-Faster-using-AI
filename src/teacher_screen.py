...
import numpy as np
from src.pipelines.face.face_pipeline import predict_attendance
...
def teacher_tab_take_attendance():
    ...
    if not subjects:
        st.warning(
            ...
            "Please create one to take attendance."
        )
        return
        ...
        if st.button(
            ...
            with st.spinner('Deep scanning classroom photos...'):
                ...
                if not enrolled_students:
                    ...
                    current_timestap = datetime.now().strftime(
                        "%Y-%m-%d %H:%M:%S"
                    )
        ...
        for sub in subjects:
            ...
            def share_btn():
                ...
                if st.button(
                    ...
                    key=f"share_{sub['subject_code']}_{sub['section']}",
                    icon=":material/share:"
                ):
...
def register_teacher(
    ...
    try:
        ...
        return (
            True,
            "Teacher registered successfully,Login Now"
        )
